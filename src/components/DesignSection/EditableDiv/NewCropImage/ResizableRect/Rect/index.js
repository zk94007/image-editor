...
export default class Rect extends PureComponent {
  ...
  startResize = (e, cursor) => {
    ...
    const onMove = (e) => {
      ...
      this.props.onResize(deltaL, alpha, rect, type, isShiftKey, clientX, clientY);
    }
  ...
  render () {
    ...
    const style = {
      ...
      outline: `${1 / this.props.zoomLevel}px solid #14a7fd`,
    }
    ...
    return (
      ...
      >
...

        {
          direction.map(d => {
            const style = {
              width: 9 / this.props.zoomLevel,
              height: 9 / this.props.zoomLevel,
              borderWidth: 1 / this.props.zoomLevel,
              borderColor: '#14a7fd',
              borderStyle: 'solid',
            }
            const dist = -5.5;
            if (d === 'nw') {
              return (
                <div key={d} className={`${zoomableMap[ d ]} square`} 
                  style={{
                    ...style,
                    top: dist / this.props.zoomLevel,
                    left: dist/ this.props.zoomLevel,
                  }}
                />
              )
            }
              ...
              return (
                <div key={d} className={`${zoomableMap[ d ]} square`} 
                  style={{
                    ...style,
                    top: dist / this.props.zoomLevel,
                    right: dist / this.props.zoomLevel,
                  }}
                />
              )
            }
            if (d === 'se') {
              return (
                <div key={d} className={`${zoomableMap[ d ]} square`} 
                  style={{
                    ...style,
                    bottom: dist / this.props.zoomLevel,
                    right: dist / this.props.zoomLevel,
                  }}
                />
              )
